...
def sum_until_prime_input():
    ...
    total = 0
    while True:
        inputint = int(input("Give an integer greater than or equal to two: "))
        total = inputint + total
        if is_prime(inputint) is True:
            break
    print("The sum of the inputted integers is", total)
...
def prime_gap(m):
    ...
    # -------------------------------------------------------------------------
    startingprime = 2
    prime = next_prime(startingprime + 1)
    while prime - startingprime != m:
        startingprime = prime
        prime = next_prime(startingprime + 1)
